...
const Hero = () => {
  return (
    <div className='py-3 mb-4'>
        <h3 className='container font-bold text-xl mt-8 ml-10 mb-4'>Recipe of the week</h3>
        <div className="container mx-auto flex flex-col md:flex-row border border-brightRed rounded-xl drop-shadow-lg">
            ...
            <div className='hero-description'>
                ...
                <p className='mb-2 w-auto'>Description: Wash ya rice, put am inside water, parboil am small. After parboiling,
